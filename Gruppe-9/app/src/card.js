...
function updatePopup(result) {
    if (result === true) {
        ...
        document.querySelector("#info b").innerHTML = "Hvis der ikke er sket noget inden for cirka 10 sekunder er der muligvis tekniske problemer. Genindlæs siden og prøv igen.";
    } else {
